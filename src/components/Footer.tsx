        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors">
                <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors">
                <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.074 0C5.452 0 .1 5.353.1 11.973 0 18.6 5.452 23.95 12.074 23.95s12.074-5.35 12.074-11.977C24.148 5.353 18.696.001 12.074.001zm4.618 12.3h-1.681c-.555 0-.75.4-.75.961v1.228h2.431l-.322 2.444H14.26v6.266h-2.93v-6.266H9.59v-2.444h1.74v-1.487c0-1.933 1.004-2.99 2.927-2.99h2.434v2.288z"/>
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors">
                <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/about" className="text-white/80 hover:text-primary transition-colors">About Us</a></li> {/* Added About Us link */}
              ...
              <li><a href="#testimonials" className="text-white/80 hover:text-primary transition-colors">Testimonials</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-white/80">Designer Blouses</span></li>
              <li><span className="text-white/80">Traditional Kurtas</span></li>
              <li><span className="text-white/80">Long Frocks</span></li>
              <li><span className="text-white/80">Half-Sarees</span></li>
              <li><span className="text-white/80">Alterations</span></li>
            </ul>
          </div>
        </div>
